...
Hay que empezar por el principio, escoger un proyecto y montar el
grupo que esté a cargo del mismo. Algunos proyectos están en el
...
[añadir al fichero el nombre del proyecto, el autor y un enlace al mismo y hacer un **pull request*](https://github.com/JJ/IV-2015-16/practicas/1).

Cada proyecto tendrá su propio repositorio en GitHub. La explicación
del proyecto deberá incluir las herramientas que se cree que se van a
...
en ficheros *de texto* junto con la aplicación. *No se permitirán ficheros
