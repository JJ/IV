...
Este [http://www.youtube.com/watch?v=KX5QV4LId_c](video de RedHat)
...
configuración en `/etc/cggroup.conf` se pueden controlas los
diferentes grupos de control y limitar y contabilizar el uso de
recursos por parte de los diferentes procesos que se hayan asignado en
los grupos.
...
anterior. 
	...
	cgexec   -g memory,cpu,cpuacct:teestoyviendo/sp lowriter
	
Con `cgclassify`, para finalizar, podemos cambiar un proceso de
