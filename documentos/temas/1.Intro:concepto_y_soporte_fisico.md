...
En el [2.Tecnicas_de_virtualizacion.md](siguiente tema) usaremos
diferentes técnicas de virtualización y gestión de máquinas
virtuales. Previamente habrá que [../practicas/1.PaaS.md](realizar la
práctica correspondiente a esta materia). 
