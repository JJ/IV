...
Una vez comprendidos los conceptos de desarrollo basado en pruebas, se
puede probar
a
[configurar directamente un sistema de CI](Integracion_continua.md),
pasando previamente
por [comprender cómo funcionan los contenedores](Contenedores.md).
