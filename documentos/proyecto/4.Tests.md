...
desplegar, en este objetivo es suficiente con que se trabaje sobre la biblioteca o
...
en objetivos posteriores). Los tests son de funciones (o métodos) y unitarios, y
...
en el objetivo anterior, las especificaciones y las funcionalidades tendrán que
