...
> Se recuerda al estudiante que este objetivo no consiste en "buscar
   ...
   aparezca en Google".  Hay que demostrar que realmente se entiende qué es un
...
anteriores y
[añadir al fichero de este hito](https://github.com/JJ/IV-21-22/blob/master/proyectos/objetivo-4.md)
