...
> 🧠 [Versión esquematizada](1.Planificacion-adapted.md)
...
Como en el [objetivo anterior](0.Repositorio.md), la **asistencia a
las prácticas** es obligatoria hasta la superación del mismo, para
poder resolver sobre la marcha las dudas que se planteen, recibir
explicaciones genéricas que puedan ayudar a la comprensión del mismo,
así como sus diferentes subobjetivos. También se podrá explicar
conceptos anteriores a la asignatura que no estén del todo claros.

## Prerrequisitos

El [objetivo 0](0.Repositorio.md) deberá haber pasado los tests en el
repositorio de la asignatura antes de poder entregar este.
...
Es esencial que se entienda que este no es *un ejercicio* de
planificación. Son las HUs y los *milestones* que *el estudiante* va a
usar el resto de la asignatura.

Este objetivo también es **bloqueante**. El no superarlo lleva automáticamente a
un no apto en la convocatoria correspondiente.
...
Vamos a plantearnos en este objetivo, sobre todo, la respuesta a la
primera pregunta, es decir, plantear, a partir de la comprensión y la
expresión de las necesidades del cliente, la infraestructura del
proyecto de forma que, en cada momento, se sepa cómo uno mismo o la
persona que se encargue de ello se ponga a trabajar inmediatamente en
lo que sea necesario *a continuación*. Pero, evidentemente, las
historias de usuario son esenciales, porque expresan un problema, para
que se pueda evaluar si cualquier solución que se desarrolla es
correcta.
...
En esta asignatura se va desarrollando un proyecto. Este objetivo
pretende cubrir la organización inicial del mismo. Por lo tanto, hay
que tratar de preguntarse, tras la elaboración de HUs y *milestones*,
si una persona ajena al mismo sería capaz de comenzar el desarrollo en
...
El siguiente producto tendrá que incluir la lógica de negocio, así como la
...
`[IV-26-27]` para que pueda filtrar fácilmente los mensajes recibidos. Cuando se
...
> Usar las mismas palabras que se usan aquí para describir tu producto
> lo convierte en incorrecto automáticamente. Los ejemplos en estos
> guiones no están para que los copiéis, sino para que comprendáis
> conceptos y los generalicéis.
...
Si no se supera en los plazos anteriores, con este objetivo sucede como con el
anterior: hay que *entregarlo* en todo caso para poder entregar los siguientes,
y *superarlo* si se quieren llevar a cabo con cierta garantía de éxito. En todo
caso, la superación del objetivo ya no contará para la convocatoria ordinaria,
sino la extraordinaria. Sin embargo, si se siguen superando los objetivos
siguientes habrá que hacerlo *hasta el 7* para conseguir la puntuación
equivalente al aprobado en convocatoria ordinaria.
