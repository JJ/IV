...
iteraciones, versiones cada vez más avanzadas de un proyecto. 

Para alcanzar este objetivo, se tendrá el inicio del trabajo, cuyo objetivo final será
...
tendrán que documentar *en un issue de GitHub*. Los issues del proyecto que sean
