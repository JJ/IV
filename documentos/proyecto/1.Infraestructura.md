# Objetivo 1: Estructura general del proyecto
...
especificaciones o al menos la estructura general de las clases o
módulos que se van a usar en el proyecto.

## Prerrequisitos

Se tendrá que haber alcanzado el [objetivo 0](0.Repositorio.md) antes
de poder avanzar al siguiente objetivo.
...
## Se habrá alcanzado este objetivo si:
...
4. Se ha organizado correctamente en el
