...
8. ¿Los milestones iniciales son internos, y hay a continuación milestones o
   productos externos?
9. ¿Los milestones son mínimos, es decir, incluyen un producto
   mínimamente viable para poder avanzar?
10. ¿El milestone 0 es mínimo *y* viable?
11. ¿Se indica claramente cómo comprobar la viabilidad del PMV de cada hito? Es
    decir, ¿se dice qué requisitos técnicos tiene que cumplir el producto de
    cada hito?
12. ¿Entre dos milestones consecutivos, no hay ningún PMV posible o por el
...
En el curso 2020-21, el 50% de los estudiantes entregó este objetivo en **12** días.
