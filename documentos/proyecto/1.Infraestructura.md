...
En este objetivo se busca es que se entienda el sistema de desarrollo
...
indicará al estudiante para su mejora. También se testearán a la hora de hacer el envío. Es
...
2. ¿He tenido en cuenta que se trata de un proyecto que se desplegará
   en la nube en las mismas?
3. ¿Están descritos todos los conceptos mencionados en las HUs con
   suficiente claridad, generalmente en documentos aparte?

En general, la pregunta sería: si entregara estos hitos y milestones
a otra persona, ¿sería capaz de ponerse a desarrollar?
