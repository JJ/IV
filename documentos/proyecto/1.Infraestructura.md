...
>El proyecto es en cualquier caso invidual y debe tener entidad por sí
...
[añadir al fichero el nombre del proyecto, el autor y un enlace al mismo y hacer un **pull request**](https://github.com/JJ/IV18-19/blob/master/proyecto/hito-1). 
