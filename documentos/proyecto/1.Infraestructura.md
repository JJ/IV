...
2. Seguir un proceso para entender los diferentes tipos de usuario que quieren
   resolver ese problema. Habrá que perfilar estos tipos de usuario.

> Por favor, evitar usuarios tipo "administrador" que tendrá que haber (casi)
   siempre. Por  ejemplo, en un sitio de ventas, habrá perfiles tipo "comprador"
   y perfil tipo "vendedor". Estos usuarios tendrán que documentarse para
