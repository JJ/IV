...
1](1.Infraestructura) y partir de las mismas para poder resolver el problema.
...
Se tendrá que haber avanzado en el [objetivo 1](1.Infraestructura) hasta
...
1](1.Infraestructura). El desarrollo ágil está centrado en el cliente, y el
...
artículo](https://www.linkedin.com/pulse/los-issues-y-su-importancia-en-la-organizaci%2525C3%2525B3n-de-un-proyecto-merelo%3FtrackingId=KU%252Bq4aOxQZu7aPJASjKKTg%253D%253D/?trackingId=KU%2Bq4aOxQZu7aPJASjKKTg%3D%3D). Los
*issues* son herramientas imprescindibles en el desarrollo de un proyecto, y
...
3. Este objetivo tiene un porcentaje importante de solución de problemas, y un
   ...
   más adelante ([objetivo 4](4.Tests)) probaremos; estas palabras clave
...
útil para su [objetivo 4](4.Tests), así que cuanto más avance quien
...
1](1.Infraestructura) *deben ser guía suficiente* para los dos retos
