...
> - **Entregable:** Un **Pull Request** con el título que incluya `[IV-24-25]`, que contenga: historias de usuario en *issues*, milestones en GitHub, un directorio `docs`, un `README.md` actualizado con enlaces, y una entrada añadida a [este fichero](https://github.com/JJ/IV-/blob/master/proyectos/objetivo-1.md) (nombre del proyecto, autor, enlace al PR).
> - **Carácter:** ⚠️ **BLOQUEANTE**. No superarlo equivale a **No Apto** en la convocatoria correspondiente.
> - **Prerrequisitos:** El [objetivo 0](0.Repositorio.md) debe haber pasado ya los tests del repositorio de la asignatura.
