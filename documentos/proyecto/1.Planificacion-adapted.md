...
> - **Entregable:** Un **Pull Request** con el título que incluya `[IV-26-27]`, que contenga: historias de usuario en *issues*, milestones en GitHub, un directorio `docs`, un `README.md` actualizado con enlaces, y una entrada añadida a [este fichero](https://github.com/JJ/IV-/blob/master/proyectos/objetivo-1) (nombre del proyecto, autor, enlace al PR).
