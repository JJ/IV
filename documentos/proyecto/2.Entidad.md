...
2. ¿Se ha documentado qué análisis se ha hecho sobre el dominio para decir lo
   que se ha creado?
3. ¿Se ha documentado por qué se ha elegido que lo creado sea un objeto valor,
   una entidad o un agregado?
4. ¿He propuesto un producto mínimamente viable, que en general será un solo
