...
(lo que efectivamente *hace* la aplicación) de su implementación completa (cómo va a
...
(que están expresados en historias de usuario), y
...
2. Tratar de crear issues "como programador" asignados a esas historias de
   usuario, tmabién organizadas de forma lógica.
...
4. Los issues están correctamente encuadrados dentro de una HU y del primer
