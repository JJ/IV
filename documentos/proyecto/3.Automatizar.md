...
* Sobre los
  [*task runners*](https://jj.github.io/IV/preso/gestores-tareas.html) o
  gestores de tareas.
* Sobre los [gestores de
  dependencias](https://jj.github.io/IV/preso/gestores-deps.html).
* Sobre los [criterios de
  elección](https://jj.github.io/IV/preso/criterios-herramientas.html).
