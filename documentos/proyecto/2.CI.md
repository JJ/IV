...
se corrija. También tendrá que incluir, a partir de esta versión, el *badge* de Travis que indica si se han pasado los tests correctamente o no.

> Si se va usar otro sistema de integración continua, avisar al profesor para que cambie los tests.
...
externo al `README.md`, que deberá ser lo más conciso posible para el
visitante casual (sin dejar de incluir enlaces claros para que quien
corrija el hito pueda encontrarlos fácilmente). Esta documentación, en
