...
Como en la práctica anterior, el URL del servicio web desplegado en un
contenedor se pondrá en una sola línea de esta forma
...
* 2 puntos: Dockerfile y otros ficheros de despliegue de la aplicación en
