...
repositorio. Y sobre Alpine, [conviene consultar este
artículo](https://github.com/JJ/IV/actions/workflows/pages/pages-build-deployment).
...
> se podrá escribir en el mismo. Muchos sistemas de gestión de
...
El alcanzar este objetivo avanzará, en principio, 5% de la puntuación del
proyecto.
