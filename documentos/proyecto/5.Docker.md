...
* [ ] ¿Se ha abierto un shell en el contenedor y comprobado que los ficheros que
se necesitan están todos incluidos, y que no hay ficheros que no se necesiten?
```
...
enlazada dese el README, que, como en todos los objetivos, reflejará el
