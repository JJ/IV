...
---
Hito 5º: Despliegue desde 0 de una aplicación en la nube.
=====================================
...
Haber alcanzado
el 50% de los objetivos de los temas de [gestión de infraestructuras](../temas/Gestion_de_configuraciones) y
...
equipo (si lo hubiera), siempre que se
...
1. Que el README.md describa el proyecto para una persona que se
   acerque al mismo por primera vez; evidentemente, esto no quita que
   haya que añadir enlaces a la documentación adicional necesaria para
   corregir y por supuesto las líneas con información para que se
   pueda testear automáticamente.
...
[documento](https://github.com/JJ/IV-18-19/blob/master/practicas/hito-5)
...
* 2 puntos: Presentación oral, documentación en el README.md y
  coordinación del proyecto con otros. 
