...
> Es imprescindible que el estudiante lea este documento **desde el principio al final**, entendiendo su intención y
> qué es lo que pide. El realizar correctamente este primer objetivo, y hacerlo
> a tiempo, le permitirá continuar en la asignatura con más fluidez, pero sobre
> todo le ahorrará trabajo de corrección de las entregas y le permitirá
