...
**bloqueante**, si no lo superas equivale a un no apto en la convocatoria
correspondiente.
...
pre-rellena con tu nick de GitHub si lo has
proporcionado)](https://github.com/JJ/IV-/blob/master/proyectos/objetivo-0.md),
el nombre del proyecto, un enlace *al PR que has creado desde una rama de tu
