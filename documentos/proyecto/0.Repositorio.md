...
> devuelva una IA generativa* en general, **va a ser incorrecto**,
> porque es el estudiante el que tiene que aplicar la metodología, y
> esto no incluye *en ningún momento* el uso de herramientas
> generativas para que lo hagan por él. Si por cualquier razón el
> estudiante lee lo que ha puesto otro compañero, *que sea para no
> repetir en ningún caso ni sus decisiones ni sus palabras*.
