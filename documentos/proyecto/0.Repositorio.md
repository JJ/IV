...
aquí. En el [siguiente objetivo](1.Planificacion.md) tendrá que plantear los
...
problema del usuario). El estudiante puede consultar el [objetivo 2](2.Modelo.md) y el
[4](4.Tests.md) para ver cómo tiene que usar en la práctica este concepto para
...
propio a partir del [objetivo 4](4.Tests.md). Si durante la corrección
...
siguiente](1.Planificacion.md) objetivo. Se pueden tener todos los PRs
