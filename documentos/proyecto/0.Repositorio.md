...
problema del usuario). Consulta el [objetivo 2](2.Modelo) y el
[4](4.Tests) para ver cómo tienes que usar en la práctica este concepto para
...
> programada por el estudiante, principalmente en el [objetivo 4](4.Tests), y
...
Sin embargo, al tratarse de la idea sobre la que se va a trabajar, no se puede
...
de los objetivos será para la convocatoria ordinaria, a salvo, claro está, de
los plazos específicos que se requieren para cada uno de ellos.
...
mensajes e commit explican por qué se ha hecho algo.
