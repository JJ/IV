...
Los plazos para la convocatoria ordinaria son:

* Dos semanas para la entrega (a partir del comienzo del curso)
* Cinco semanas para la superación.
...
Por esto, el plazo
  *máximo* para superar el objetivo *en convocatoria ordinaria* es de 5 semanas
  a partir del principio del curso.
