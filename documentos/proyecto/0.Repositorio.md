...
Puedes consultar [el material
correspondiente](../objetivos/0.Infraestructura.md) o por supuesto consultar al
profesor; el proceso de *design thinking* para decidir sobre qué problema
...
días](https://raw.githubusercontent.com/JJ/IV/master/calendarios/0-la-mitad.ics),
el 75% en [**10**
días](https://github.com/JJ/IV/blob/master/calendarios/0-tres-cuartos.ics).
