...
> 🧠 [Versión esquematizada](0.Repositorio-adapted.md)
...
Esta asignatura tiene una serie de mecanismos específicos, diferentes
de cualquier otra asignatura impartida en la ETSIIT, para su entrega y
evaluación; el trabajo se preparará y se evaluará usando los mismos
mecanismos que se usan en las empresas de desarrollo de software. Con
este objetivo se pretende que el estudiante aprenda a usar
correctamente estos mecanismos, así como el proceso de aprendizaje
...
En general, el estudiante va a tener que aprender una serie de
técnicas y metodologías que le serán útiles en su carrera
profesional. Usándolas en la práctica se aprenden rápidamente y sin
dolor (y no habrá exámenes de ello).
