...
[fichero de este hito](https://github.com/JJ/IV-21-21/blob/master/practicas/hito-4.md)
...
1. 3 puntos: Configuración correcta de herramientas de construcción y
  prueba y correcta justificación de las mismas.
2. 4 puntos: Integración continua funcionando y correcta justificación
  de la misma. Para conseguir los 4 puntos, habrá que configurar algún
  sistema adicional aparte de Travis.
3. 3 puntos: Tests significativos y/o avance del proyecto en sí más
  allá de lo básico.
